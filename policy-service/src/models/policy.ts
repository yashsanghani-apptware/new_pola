...
import {
  Metadata, PrincipalPolicy, ResourcePolicy, DerivedRole, ExportVariable, RolePolicy, 
  GroupPolicy, AuditInfo, EventPolicy, ServiceControlPolicy
} from './types';
...
export interface Policy extends Document {
  ...
  eventPolicy?: EventPolicy;              // Optional policy defining event action rules
  groupPolicy?: GroupPolicy;            // Optional policy defining rules for groups
  serviceControlPolicy?: ServiceControlPolicy; // optonal Service control policy
